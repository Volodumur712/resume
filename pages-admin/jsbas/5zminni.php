...
<div class="text-center m-3">
    <a href="/?p=jsbasics.php">back to js basics</a>
</div>

<h2 class="text-success text-center m-3">5 Змінні, робота з елементами сторінки, Star Wars</h2>

    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-warning opacity-75">
        <p><button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample1"
         aria-expanded="false" aria-controls="collapseExample">
        Урок 5.1 підготовка гри Star Wars
        </button></p>
        <div class="collapse text-center" id="collapseExample1">
            <div class="card card-body align-items-center">
            <iframe width="475" height="357" src="https://www.youtube.com/embed/yTdZr41aK7k" 
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-success opacity-75">
        <p><button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample2"
         aria-expanded="false" aria-controls="collapseExample">
        Урок 5.2
        </button></p>
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-info opacity-75">
        <p><button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample3" 
        aria-expanded="false" aria-controls="collapseExample">
        6 Введення в події, робота з тегом audio 
        </button></p>
        <div class="collapse text-center" id="collapseExample3">
            <div class="card card-body align-items-center">
            <iframe width="475" height="357" src="https://www.youtube.com/embed/ddohAYxetmE" 
                title="3й урок: введение в события, работа с тегом audio" frameborder="0" allow="accelerometer; 
                autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <p></p>
                <a href="https://docs.google.com/document/d/1ntOUllzK7b4R8IWfyD2j5G1GsKF9z3a0FKjKAx2VwwU/edit#heading=h.7bablqealwke"
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-warning opacity-75">
        <p><button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample4" aria-expanded="false" 
        ...
        <div class="collapse text-center" id="collapseExample4">
            ...
            <iframe width="475" height="357" src="https://www.youtube.com/embed/XPfiFrSv9Gg" 
                ...
                <a href="https://docs.google.com/document/d/1ntOUllzK7b4R8IWfyD2j5G1GsKF9z3a0FKjKAx2VwwU/edit#heading=h.7bablqealwke"
                 target="_blank">умови</a>
                <a href="https://learn.javascript.ru/logical-operators" target="_blank">логічні</a>
                <a href="https://developer.mozilla.org/ru/docs/Learn/JavaScript/First_steps/Strings#
                %D0%BA%D0%BE%D0%BD%D0%BA%D0%B0%D1%82%D0%B5%D0%BD%D0%B0%D1%86%D0%B8%D1%8F_%D1%81%D1%82%D1%80%D0%BE%D0%BA" 
                target="_blank">конкантенація</a>
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-success opacity-75">
        <p><button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample5" aria-expanded="false" 
        aria-controls="collapseExample">
        ...
        <div class="collapse text-center" id="collapseExample5">
            ...
            <iframe width="475" height="357" src="https://www.youtube.com/embed/CBz9lcJ7r6g" 
                ...
                autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <p>Зробити переміщення кулі в кінець ігрового поля, зліва направо. Після вильоту за межі поля повертати її на початок поля, 
                    на кшталт як я зробив приклад з ворогом.
                </br>
                Зробити заборону на переміщення гравця за межі ігрового поля вгору та вниз. 
                </br>Щоб на кордонах він не смикався і не стрибав. Підказка – потрібно спочатку перевіряти позицію гравця, 
                а потім виконувати рух)))</p>
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-info opacity-75">
        <p><button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample6" aria-expanded="false" 
        aria-controls="collapseExample">
        ...
        <div class="collapse text-center" id="collapseExample6">
            ...
            <iframe width="475" height="357" src="https://www.youtube.com/embed/3kHePCjl7K8" 
                ...
                autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <p>Зробити створення кулі при натисканні на пробіл.
                     Коли куля долітає до кінця поля, видаляти кулю і зупиняти таймер кулі.</p>
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-warning opacity-75">
        <p><button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample7"
         aria-expanded="false" aria-controls="collapseExample">
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-success opacity-75">
        <p><button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample8" 
        aria-expanded="false" aria-controls="collapseExample">
