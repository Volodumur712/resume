...
<h2 class="text-success text-center m-3"></h2>
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-warning opacity-75">
        ...
        <div class="collapse text-center" id="collapseExample1">
            ...
            <iframe width="475" height="357" src="https://www.youtube.com/embed/Oc-U7Mwn_Y8" 
                title="Git урок 3. Команди clone, status, push and pull" frameborder="0" allow="accelerometer; 
