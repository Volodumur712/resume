...
<h2 class="text-success text-center m-3">3 Модуль Front-end. Урок 2 - Верстка сайтів, базові принципи</h2>
...
Пропиши колір, розмір та потрібний шрифт для пунктів меню у блоці хедер.</p>
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-success opacity-75">
        ...
        <div class="collapse text-center" id="collapseExample2">
            <div class="card card-body align-items-center">
            <iframe width="475" height="357" src="https://www.youtube.com/embed/7vEFHGl5Tc8" 
                title="Модуль Front-end. Урок 2 - Делаем блок с картинкой на бекграунде" frameborder="0" allow="accelerometer; 
                autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <p></p>
                <a href="" target="_blank"></a>
            </div>
