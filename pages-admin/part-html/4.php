...
<h2 class="text-success text-center m-3">5  JS та jQuery необхідна база</h2>
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-warning opacity-75">
        ...
        <div class="collapse text-center" id="collapseExample1">
            ...
            <iframe width="475" height="357" src="https://www.youtube.com/embed/-TOQMrI8CBU" 
                title=" Стилизация слайдера" frameborder="0" allow="accelerometer; 
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-success opacity-75">
        ...
        <div class="collapse text-center" id="collapseExample2">
            ...
            <iframe width="475" height="357" src="https://www.youtube.com/embed/OtG4PDboycM" 
                title=" Слайдер на чистом JavaScript" frameborder="0" allow="accelerometer; 
                autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
показуй її у великому вигляді.</p>
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-info opacity-75">
        ...
        <div class="collapse text-center" id="collapseExample3">
            <div class="card card-body align-items-center">
            <iframe width="475" height="357" src="https://www.youtube.com/embed/eBMgunPQtDY" 
                title=" Реализация слайдера на jQuery" frameborder="0" allow="accelerometer; 
                autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <p></p>
                <a href="https://habr.com/ru/post/38208/" target="_blank">habr</a>
                <a href="https://oscarotero.com/jquery/" target="_blank">jquery</a>
                <a href="https://msiter.ru/tutorials/jquery/jquery_get_started" target="_blank">jquery_get_started</a>
            </div>
        </div>
    </div>
