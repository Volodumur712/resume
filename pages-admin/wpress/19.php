...
<h2 class="text-success text-center m-3">19 Углубленный Web: разработка сайта на WordPress</h2>
<h3 class="text-success text-center m-3">варіант 2</h3>
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-warning opacity-75">
        ...
        <div class="collapse text-center" id="collapseExample1">
            ...
            <iframe width="475" height="357" src="https://www.youtube.com/embed/cWzGn7nSqVE" 
        title="1. Углубленный Web: разработка сайта на WordPress" frameborder="0" allow="accelerometer; 
