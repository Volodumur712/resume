...
<h2 class="text-success text-center m-3">Модуль WP. Урок 4 — Міграції баз даних. Оптимізація. Інтернет магазин на wordpress</h2>
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-warning opacity-75">
        ...
        <div class="collapse text-center" id="collapseExample1">
            ...
            <iframe width="475" height="357" src="https://www.youtube.com/embed/xGCg9CL8miQ" 
        title="1. Міграції баз даних" frameborder="0" allow="accelerometer; autoplay; 
        clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                <p></p>
                <a href="https://ru.wordpress.org/plugins/wp-migrate-db/" target="_blank">A</a>
            </div>
        </div>
    </div>
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-success opacity-75">
        ...
        Оптимізація проектів на wordpress 
        </button></p>
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-info opacity-75">
        ...
        <div class="collapse text-center" id="collapseExample3">
            <div class="card card-body align-items-center">
            <iframe width="475" height="357" src="https://www.youtube.com/embed/ndv-VTmX1g4" 
        title="3. Інтернет магазин на wordpress" frameborder="0" allow="accelerometer; autoplay; 
        clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                <p></p>
    ...
    <div class="text-center m-4 p-3 border border-primary rounded-pill border-5 bg-warning opacity-75">
        ...
        <div class="collapse text-center" id="collapseExample4">
            <div class="card card-body align-items-center">
            <iframe width="475" height="357" src="https://www.youtube.com/embed/OF8E1Ay0jsc" 
        title="4. Останні штрихи" frameborder="0" allow="accelerometer; autoplay; 
        clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                <p></p>
