...
<header id="header" class="d-flex flex-column justify-content-center">
  ...
  <?php if(isset($_SESSION['user_id']) && $_SESSION['user_id'] != null) { ?>
        ...
        <li <?php if(!isset($_GET['p']) || $_GET['p'] == 'ph_p'): ?> <?php endif; ?> ><a href="/?p=ph_p.php"><i class="bx bx-book-content"></i> <span>PHP</span></a></li>
        <li <?php if(!isset($_GET['p']) || $_GET['p'] == 'wordpres'): ?> <?php endif; ?> ><a href="/?p=wordpres.php"><i class='bx bx-code-block'></i><span>Wordpres</span></a></li>
        <li <?php if(!isset($_GET['p']) || $_GET['p'] == 'git'): ?> <?php endif; ?> ><a href="/?p=git.php"><i class='bx bxs-like bx-tada'></i><span>Git</span></a></li>
