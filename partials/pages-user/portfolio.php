      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-js">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/rulet.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Ruletka</h4>
                <p>Game on JS</p>
                <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-php">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/two-php.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Presentation version</h4>
                <p>What can i do with PHP</p>
                <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-html">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/lemon-hed.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Presentation version</h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-js">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/pazl.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Pazl</h4>
                <p>Game on JS</p>
                <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-html">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/kw1.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Сalculator</h4>
                <p>Kom Work 2</p>
                <div class="portfolio-links">
